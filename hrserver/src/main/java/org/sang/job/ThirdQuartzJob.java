...
public class ThirdQuartzJob implements Job, Serializable {
    
    private static final Logger logger = LoggerFactory.getLogger(ThirdQuartzJob.class);
    private static final long serialVersionUID = 1L;

    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
         System.out.println("quartz 任务 多个 测试");
        
         System.out.println("fucking!  NewJob is executing." + new Date() );  
         //取得job详情  
