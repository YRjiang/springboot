...
public class JobEntity implements Serializable {
    ...
    public String toString() {
        return "JobEntity{" + "id=" + id + ", name='" + name + '\'' + ", group='" + group + '\'' + ", cron='" + cron
                + '\'' + ", parameter='" + parameter + '\'' + ", description='" + description + '\'' + ", vmParam='"
                + vmParam + '\'' + ", jarPath='" + jarPath + '\'' + ", icon='" + icon + '\'' + ", status='" + status
                + '\'' + '}';
    }
    ...
    public static class Builder {
        ...
        public Builder withIconCls(String i) {
            icon = i;
            return this;
        }
